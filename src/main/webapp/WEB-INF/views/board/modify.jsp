...
$(document).ready(function(){
	...
	var formObj = $("form"); // 위에 form태그를 변수에 넣는다.
	
	$('button').on("click", function(e){
		
		e.preventDefault(); // 기존에 세팅된 기능을 사용하지 않겠다.
		// 버튼을 눌러도 action="/board/modify" method="post" 가능 사용하지 않음
		
		var operation = $(this).data("oper");
		// data-oper='modify' & data-oper='remove' & data-oper='list'
		
		console.log(operation); // 크롬브라우저 콘솔에 같이 찍힘
		...
		// data-oper='modify' 는 기본 액션태그 내용대로 진행됨
